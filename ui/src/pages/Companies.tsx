...
export function Companies() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">กำลังโหลดบริษัท...</p>}
                ...
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">งบไม่จำกัด</span>}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 ml-auto">
                  <Calendar className="h-3.5 w-3.5" />
                  <span>สร้างเมื่อ {relativeTime(company.createdAt)}</span>
                </div>
              </div>
              ...
              {isConfirmingDelete && (
                ...
                >
                  <p className="text-sm text-destructive font-medium">
                    ลบบริษัทนี้และข้อมูลทั้งหมด? การดำเนินการนี้ไม่สามารถย้อนกลับได้
                  </p>
