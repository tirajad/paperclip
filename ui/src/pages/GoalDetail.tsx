...
export function GoalDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: goal?.title ?? goalId ?? "เป้าหมาย" }
    ]);
      ...
      <Tabs defaultValue="children">
        <TabsList>
          <TabsTrigger value="children">
            เป้าหมายย่อย ({childGoals.length})
          </TabsTrigger>
          <TabsTrigger value="projects">
            โปรเจกต์ ({linkedProjects.length})
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="children" className="mt-4 space-y-3">
          ...
          {childGoals.length === 0 ? (
            <p className="text-sm text-muted-foreground">ยังไม่มีเป้าหมายย่อย</p>
          ) : (
        ...
        <TabsContent value="projects" className="mt-4">
          {linkedProjects.length === 0 ? (
            <p className="text-sm text-muted-foreground">ยังไม่มีโปรเจกต์ที่เชื่อมโยง</p>
          ) : (
