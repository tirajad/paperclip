...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: "สร้างเอเจนต์ใหม่",
      description: "(พิมพ์ประเภทเอเจนต์ที่คุณต้องการที่นี่)",
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">เพิ่มเอเจนต์ใหม่</span>
          <Button
            variant="ghost"
            size="icon-xs"
          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  เราแนะนำให้ CEO ของคุณจัดการการตั้งค่าเอเจนต์ — เขารู้โครงสร้างองค์กรและสามารถกำหนดค่าการรายงาน สิทธิ์ และอะแดปเตอร์ได้
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                <Bot className="h-4 w-4 mr-2" />
                ขอให้ CEO สร้างเอเจนต์ใหม่
              </Button>
            ...
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  เลือกประเภทอะแดปเตอร์สำหรับการตั้งค่าขั้นสูง
                </p>
              </div>
