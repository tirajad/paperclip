        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-[11px] uppercase tracking-[0.22em] text-red-200/80">
              {incident.scopeType} หยุดฉุกเฉิน
            </div>
            ...
            <CardDescription className="mt-1 text-red-100/70">
              ค่าใช้จ่ายถึง {formatCents(incident.amountObserved)} เทียบกับวงเงิน {formatCents(incident.amountLimit)}
            </CardDescription>
          </div>
        ...
        <div className="flex items-start gap-2 rounded-xl border border-red-400/20 bg-red-500/10 px-3 py-2 text-sm text-red-50/90">
          ...
          <div>
            {incident.scopeType === "project"
              ? "การดำเนินการโปรเจกต์ถูกหยุดชั่วคราว งานใหม่ในโปรเจกต์นี้จะไม่เริ่มจนกว่าคุณจะแก้ไขเหตุการณ์งบประมาณ"
              : "ขอบเขตนี้ถูกหยุดชั่วคราว Heartbeat ใหม่จะไม่เริ่มจนกว่าคุณจะแก้ไขเหตุการณ์งบประมาณ"}
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border/60 bg-background/60 p-3">
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row">
            ...
            >
              ...
              {isMutating ? "กำลังดำเนินการ..." : "เพิ่มงบประมาณและดำเนินการต่อ"}
            </Button>
          </div>
          {parsed !== null && parsed <= incident.amountObserved ? (
            <p className="mt-2 text-xs text-red-200/80">
              งบประมาณใหม่ต้องมากกว่าค่าใช้จ่ายที่สังเกตได้ในปัจจุบัน
            </p>
          ) : null}
        </div>
